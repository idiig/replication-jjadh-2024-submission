...
![697 番歌の @matsuda1968Shinshaku による現代語訳：アライメントの結果を書き換えている；「しきしまのやまとにはあらぬからころも」が省略されている。Contemporary translation of Poem #697 by @matsuda1968Shinshaku: The alignment has been revised; the *jokotoba* "Shikishima no Yamato ni wa aranu kara koromo" has been omitted.](./figures/matsuda-697.svg){#fig-mtd-697 width=100%}
...
![アライメント（後半）：秋の木の葉の 幣と散るらめ Alignment (second half): aki no konoha no nusa to chiru rame 'leaves of autumn may be scattered as scared papers (which is dedicated to the god)'](./figures/tatsuta-2.svg){#fig-alignment-2 width=100%}
