...
<!-- | Author                       | Year   | annotated books title                         | -->
<!-- | Author 著者                   | Year 発行年  | annotated books title  注釈書名       | -->
<!-- | ---------------------------- | ------ | --------------------------------------------- | -->
...
<!-- 近代前（1600--1868）の古今集の代表的な注釈書 Representative ../ of *Kokinshū* before modern times (1600--1868) -->

```{r}
#| label: tbl-annotation
#| tbl-cap: "近代前（1600--1868）の古今集の代表的な注釈書 Representative annotated books of *Kokinshū* before modern times (1600--1868)"

main.title <- "近代前（1600−1868）の古今集の代表的な注釈書"
subtitle <- expression(paste("Representative annotated books of ", italic("Kokinshū"), " before modern times (1600−1868)"))
cols <- c("著者\nAuthor", "発行年\nYear", "注釈書名\nannotated books Title")
...
<!-- |     | Abbr. 略号 | annotated books 注釈書  | Manuscript 底本  | Token count トークン数 | Type count タイプ数 | Document count 文書数 | -->
<!-- |-----|-------|--------------------|-------------|------------:|-----------:|---------------:| -->
...
公開できるデータである @kaneko1933Kokin による現代語訳の分割語彙データは [https://github.com/yamagen/kokin-kaneko](https://github.com/yamagen/kokin-kaneko) にて参照する。

# 補足材料 {.appendix .unnumbered}

補足資料は、[https://github.com/idiig/replication-jjadh-2024-submission/blob/main/supplementary_materials](https://github.com/idiig/replication-jjadh-2024-submission/blob/main/supplementary_materials) を参照する。再現実験について、[https://github.com/idiig/replication-jjadh-2024-submission/tree/main](https://github.com/idiig/replication-jjadh-2024-submission/tree/main) を参照する。
